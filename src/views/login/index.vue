...
export default {
  ...
  data() {
    const validateMobile = (rule, value, callback) => {
      ...
      //   callback()
      // }
      validMobile(value) ? callback() : callback(new Error('手机号格式有误'))
    }
    ...
    return {
      ...
      loginRules: {
        ...
        password: [{ required: true, trigger: 'blur', message: '密码不能为空' }, { trigger: 'blur', min: 6, max: 16, message: '密码长度在6-16位' }]
      },
      loading: false,
